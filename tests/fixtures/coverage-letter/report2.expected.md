...
- **Structure & Pacing — 92/100 — not comparable** — Structure & Pacing is in good shape — a handful of minor notes, mostly around weak midpoint.
- **Character — 95/100 — not comparable** — Character is in good shape — a handful of major notes, mostly around zero entropy scene.
- **Dialogue & Voice — 99/100 — not comparable** — Dialogue & Voice is in good shape — a handful of minor notes, mostly around dialogue staccato overuse.
- **Plot Logic & Payoff — 82/100 — not comparable** — Plot Logic & Payoff is in good shape — a handful of major notes, mostly around unmotivated decision.
- **Theme & Originality — 100/100 — not comparable** — Theme & Originality is in good shape — a handful of minor notes, mostly around slug generic location.

## Root Causes

1. **MAJOR — Widespread Structure & Pacing concerns** — 8 issues across 2 pass(es) in Structure & Pacing point to the same underlying problem, mostly around no reversals. Subsumes 8 issues.
...
3. **MAJOR — End of Act 2 (Scene ~5)** — Scene 5 (Act 2 ending) has low suspense delta (-1.0) — Act 2 should end with a climactic turn that forces entry into Act 3. Suggested fix: The final Act 2 scene should be the highest-stakes moment before the climax: a major reversal, false climax, or all-is-lost moment.
...
6. **MAJOR — Scenes 1–3 (setup zone)** — 2 clue(s) seeded in the first half (jane, mark) have no matching payoff anywhere in the story — Chekhov's gun shown but never fired. Suggested fix: Either fire the gun: add a payoff scene that calls back each planted clue. Or remove the clue from Act 1 if you don't intend to resolve it.
7. **MAJOR — Scene 2 (EXT. BACKYARD - CONTINUOUS)** — Scene 2 has no emotional shift, relationship change, planted clues, or clock pressure — the scene advances neither plot nor character. Suggested fix: Either add a moment where someone learns something, feels something, or commits to something; or cut the scene entirely.
8. **MAJOR — Scene 3 (INT. KITCHEN - LATER)** — Scene 3 has no emotional shift, relationship change, planted clues, or clock pressure — the scene advances neither plot nor character. Suggested fix: Either add a moment where someone learns something, feels something, or commits to something; or cut the scene entirely.
9. **MAJOR — Scene 4 (INT. GARAGE - NIGHT)** — Scene 4 has no emotional shift, relationship change, planted clues, or clock pressure — the scene advances neither plot nor character. Suggested fix: Either add a moment where someone learns something, feels something, or commits to something; or cut the scene entirely.
10. **MAJOR — Scene 5** — A revelation scene delivers new information but no prior misinformation/deception makes it land as a reversal. Suggested fix: Plant a false belief in an earlier scene that this revelation will overturn.
