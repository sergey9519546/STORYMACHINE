...
landing in the ~2.1-2.7s (idle box) to ~3.9s (this box, under load — see the
`DOCTOR_POOL_PREWARM_TIMEOUT_MS` row below for the measured range) window
between the port accepting connections and
