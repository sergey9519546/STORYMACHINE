...
| 9 | Deterministic · reproducible · no LLM judge | src/components/scriptide/ScriptDoctorPanel.tsx:3428 | measured-in-repo | tests/core/script-doctor.test.ts (lines 1133, 1528) | supported |
...
| 15 | Deterministic core — Always available | src/components/SettingsPanel.tsx:812 | measured-in-repo | tests/routes/keyless-smoke.test.ts | supported |
| 16 | Story axes are deterministic engine config — no AI key required. | src/components/SettingsPanel.tsx:470 | measured-in-repo | tests/routes/keyless-smoke.test.ts | supported |
