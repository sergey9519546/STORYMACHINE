...
| 32 | Rank among your drafts: … (by health, your own saved drafts of this script) | src/components/scriptide/ScriptDoctorPanel.tsx (DraftRankLine, 2026-09-04) | measured-in-repo | tests/core/snapshot-trend.test.ts (computeDraftRank) | supported |
| 33 | First saved draft — rank among your drafts appears after your next save | src/components/scriptide/ScriptDoctorPanel.tsx (DraftRankLine, 2026-09-04) | measured-in-repo | tests/core/snapshot-trend.test.ts (computeDraftRank: "with no saved snapshots at all, the current draft is \"1st of 1\""). Qualification (audit, 2026-09-04 evening): the test proves the return value, not the promise — when saved snapshots exist but none carries a health value the same line renders and the next save does not produce a rank; a lane is splitting that state out. | supported (qualified) |
| 34 | Among your own saved drafts of this script, this one ranks … by health — a comparison to your own history, not to the reference set above or to any other writer's work. | server/lib/coverage-letter.ts (buildCaveats, draftRank branch, 2026-09-04) | measured-in-repo | tests/core/coverage-letter.test.ts ("states the draft-rank line beside (not instead of) the reference-set percentile line"); tests/routes/export-coverage-letter.test.ts | supported |
| 35 | This is your first saved draft of this script — a rank among your own drafts will appear after your next save. | server/lib/coverage-letter.ts (buildCaveats, draftRank branch, 2026-09-04) | measured-in-repo | tests/core/coverage-letter.test.ts ("renders \"first saved draft\" copy, not a fabricated rank, when of <= 1") | supported |
...
| 50 | Rank among your drafts: … (by health, your own saved drafts of this script) | server/lib/coverage-html.ts (buildDraftRankLine, 2026-09-04 — second surface for row 32's claim) | measured-in-repo | tests/core/coverage-html.test.ts ("renders the draft-rank line when opts.draftRank is provided") | supported |
| 51 | First saved draft — rank among your drafts appears after your next save | server/lib/coverage-html.ts (buildDraftRankLine, 2026-09-04 — second surface for row 33's claim) | measured-in-repo | tests/core/coverage-html.test.ts ("renders the \"first saved draft\" copy when draftRank.of <= 1") | supported |
