...
| 33 | First saved draft — rank among your drafts appears after your next save | src/components/scriptide/ScriptDoctorPanel.tsx (DraftRankLine, 2026-09-04) | measured-in-repo | tests/core/snapshot-trend.test.ts (computeDraftRank: "with no saved snapshots at all, the current draft is \"1st of 1\"") | supported |
...
| 41 | Shape & rhythm (descriptive, not part of the score): Talk/action swing … → … / Action-prose variation … → … | src/components/scriptide/ScriptDoctorPanel.tsx (FixReceiptCard structural-signals delta, 2026-09-04) | measured-in-repo | tests/core/shape-rhythm-panel-copy.test.ts; tests/routes/scriptide-fix.test.ts | supported |
