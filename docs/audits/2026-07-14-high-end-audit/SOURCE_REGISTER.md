...
| G12 | Writers Guild of America. (2026). *Artificial intelligence* [2023 MBA summary]. [WGA](https://www.wga.org/contracts/know-your-rights/artificial-intelligence) | Primary union contract/practice guidance | VII; A for MBA claim | Advocates for writer membership | AI is not a writer/literary material under MBA; company disclosure and writer-use rules | MBA-covered work only; not universal copyright or product law | WGA primary page |
