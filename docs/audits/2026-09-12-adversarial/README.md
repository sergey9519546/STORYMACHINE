...
| `scoring/forced-cue` — Fountain's `@` cue honoured at the parser seam and in every renderer (32/32 → 0/32); a ninth shape-guard bypass class the parser change itself opened, closed | scoring review round 2, non-blocking 1 | READY-FOR-OWNER | f258c405 (stacked on 4cf5b2f3; owner-gated) |
