...
**SUPPORTING DOCS**: `NORTH_STAR.md` (constitution) · `ARCHITECTURE.md` (system map) · `docs/DECISION_LOG.md` (audit trail) · `README.md` (setup) · `docs/screenplay-understanding/GODMODE_STANDARD.md` (45-level craft framework) · `docs/GODMODE_COVERAGE_MAP.md` (which levels are built/wired/gapped)
