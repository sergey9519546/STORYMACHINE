...
export const VERIFIED_GATES = [
  {
    ...
    proves:
      ...
      + 'catches it on 31 of the 32 scripts with zero inversions (the one tie is a pair clamped '
      + 'at health 0 on both sides, 2026-09-20), so a near-chance reading elsewhere is the '
    ...
    doesNotProve:
      ...
      + 'length, different denominator. And it is not a good result: measured 2026-09-20, both '
      + 'MEASUREMENT channels are near chance (shuffle-drop 0.4375 matched-pair / 0.5298 '
      + 'all-pairs; climax-relocate 0.4375 / 0.4897) and all four 95% intervals contain 0.5. '
      + 'FOUR of the six floors FELL at that re-lock, including the primary shuffle-drop one '
      + '(0.5113 -> 0.4175) — see PUBLIC_BENCHMARK_2026-09-06.md section 12. The '
      + 'control reads 0.9844 / 0.9458 but proves only that the instrument works — the engine '
