...
export function publicBenchmarkLimits(result: BenchmarkResult): string {
  ...
  return [
    ...
    '    ARC_DED_MIN_SCENES and CLIMAX_DED_MIN_SCENES are both 15, so the feature-scale',
    '    deductions never fire on this corpus at all — this benchmark measures a strictly',
    '    smaller engine than the AUC-24 ratchet does. Since 2026-09-11 the scarcity term also',
