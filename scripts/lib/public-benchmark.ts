...
export function publicBenchmarkLimits(result: BenchmarkResult): string {
  ...
  return [
    ...
    '    ARC_DED_MIN_SCENES is 15 (doctor.ts:2556), so THE one feature-scale deduction that is',
    ...
    '    wired into nothing — doctor.ts:2580-2583 records the revert: it over-fired on real scripts',
