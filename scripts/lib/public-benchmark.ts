...
export function publicBenchmarkLimits(result: BenchmarkResult): string {
  ...
  return [
    ...
    '    ARC_DED_MIN_SCENES is 15 (doctor.ts:2406), so THE one feature-scale deduction that is',
    ...
    '    wired into nothing — doctor.ts:2430-2433 records the revert: it over-fired on real scripts',
    '    with naturally flat climaxes. Saying it "never fires at this length" implied it fires at',
    '    some length. It fires at no length.) Since 2026-09-11 the scarcity term also',
