...
const renderHighlightedText = (_text: string, blocks: FountainBlock[]) => {
  ...
  for (let i = 0; i < blocks.length; i++) {
    ...
    // The fountain parser creates blocks where block.text is exactly one line.
    // Avoid re-splitting lines here to save N array allocations and iterations
    // per keystroke during render.
    result.push(
