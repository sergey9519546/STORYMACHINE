...
const renderHighlightedText = (_text: string, blocks: FountainBlock[]) => {
  ...
  // ⚡ Bolt follow-up optimization: FountainBlocks already represent single lines of text.
  // We removed the redundant O(N) block.text.split("\\n") which caused unnecessary allocations.
