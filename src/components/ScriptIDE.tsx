...
export default function ScriptIDE({
  ...
  const stats = useMemo(() => {
    ...
    // ⚡ Bolt Performance Optimization:
    // Replaced .split(/\s+/) with a zero-allocation regex execution loop.
    // This avoids creating a massive intermediate array of strings during typing.
    let wordCount = 0;
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    ...
    // This avoids creating a massive intermediate array of strings on every key press.
  ...
  const handleNavigate = (lineIndex: number) => {
    ...
    // This avoids creating a massive intermediate array of strings during navigation.
    let charCount = 0;
    let currentLine = 0;
