...
interface AiConfig {
  ...
  ttsKeySet: boolean;
  embKeySet: boolean;
  /** True when the server can use the currently selected text provider for
   *  this workflow. This is provider-aware rather than a loose "some key
   *  exists" check; see server/lib/ai-config.ts::llmReady(). */
  llmReady: boolean;
}
