...
## 2025-07-28 - Screenplay Layout Optimization
**Learning:** text.split(/\s+/) allocates intermediate arrays for every word during screenplay layout, causing GC pressure.
**Action:** Replaced with zero-allocation charCodeAt loop using accurate whitespace detection.
