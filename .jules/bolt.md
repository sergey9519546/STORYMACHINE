...
## 2024-06-30 - [Performance optimization in ScriptIDE]
**Learning:** Found unnecessary string allocations in high-frequency React render paths and event handlers in ScriptIDE (e.g. handleKeyDown, handleNavigate, stats useMemo) using .split().
**Action:** Replaced .split() with zero-allocation character loops and index methods to prevent garbage collection spikes.
