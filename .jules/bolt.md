...
## 2024-07-01 - Avoid .split() in high-frequency render paths
**Learning:** Using .split() inside React render functions creates arrays that cause massive garbage collection spikes.
**Action:** Use zero-allocation methods like .indexOf() loops or RegEx .exec() loops to extract strings instead.
