...
## 2024-06-25 - [Zero-allocation string parsing in React loops]
**Learning:** In high-frequency React paths like ScriptIDE, using String.prototype.split() for line navigation and analysis allocates large intermediate arrays, causing garbage collection spikes.
**Action:** Use zero-allocation methods like charCodeAt, indexOf, and lastIndexOf combined with slice() to operate directly on string primitives without allocating arrays.
